...
//returns null if JSON not valid
$rawData = json_decode($rawData, 1); 

$iban = ibanGenerator();
$name = $rawData['name'] ?? 0;
$surname = $rawData['lastName'] ?? 0;
$gender = $rawData['gender'] ?? 0;
$gender = (string) $gender;
$dob = $rawData['dateOfBirth'] ?? 0;
$dob = (string) $dob;
$idNo = $rawData['personalIdentityNumber'] ?? 0;
$idArray = str_split($idNo, 1);
$accNo = $rawData['accountNumber'] ?? 0;
...
<body>
    ...
    <form id="createForm" action="<?= URL ?>create.php" method="post">
        ...
        <br> <button class="accountDataSubmit" type="submit">Submit</button>
    </form>
